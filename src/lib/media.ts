...
export const defaultImageSlots: SiteImageSlot[] = [
  ...
  { key: "evento.teclado", label: "Evento - teclado", image_url: "/assets/hero-musician-5.png", alt: "Tecladista", category: "evento", position: 4 },
  { key: "evento.baixo", label: "Evento - baixo", image_url: "/assets/hero-bass.jpeg", alt: "Baixista", category: "evento", position: 5 },
