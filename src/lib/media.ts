...
export const defaultImageSlots: SiteImageSlot[] = [
  ...
  { key: "evento.guitarra", label: "Evento - guitarra", image_url: "/assets/hero-guitar.jpeg", alt: "Guitarrista", category: "evento", position: 3 },
  { key: "evento.violao", label: "Evento - violão", image_url: "/assets/hero-violao.jpeg", alt: "Músico tocando violão", category: "evento", position: 4 },
  { key: "evento.teclado", label: "Evento - teclado", image_url: "/assets/hero-musician-5.png", alt: "Tecladista", category: "evento", position: 5 },
  { key: "evento.baixo", label: "Evento - baixo", image_url: "/assets/hero-bass.jpeg", alt: "Baixista", category: "evento", position: 6 },
  { key: "causa.1", label: "Causa 1", image_url: "/assets/social-cause-1.jpeg", alt: "Família recebendo cesta básica", category: "causa", position: 1 },
  { key: "causa.2", label: "Causa 2", image_url: "/assets/social-cause-2.jpeg", alt: "Cestas básicas organizadas", category: "causa", position: 2 },
  ...
  { key: "local.3", label: "Local 3", image_url: "/assets/place-3.png", alt: "Iluminação do palco", category: "local", position: 3 }
];
